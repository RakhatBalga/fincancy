...
месяца — твой собственный, ты студент/молодой человек, живёшь в Астане, и это
ВСЯ сумма, которая у тебя есть на месяц. Распредели её целиком с нуля своими
категориями и суммами в тенге так, как сам считаешь разумным для нормальной
жизни в Астане (жильё/аренда — если её ещё нет в бюджете, питание, транспорт,
связь, немного развлечений, обязательно откладывать на подушку и т.д.). Это
твоя полностью независимая версия бюджета для этой суммы денег — не привязывай
её к тратам пользователя и ничего не сравнивай. Только твоя роспись.
