...
- Не выдумывай синонимы к существующим: "кафе", "рестораны", "перекус" → "еда вне дома".
...
- Регулярная помощь/перевод родственнику (дедушка, мама, родители, семья) →
  "помощь семье". Разовый перевод другому человеку → "переводы".
Разрешённые категории:
["продукты", "еда вне дома", "транспорт", "такси", "жильё", "коммуналка",
 "связь и интернет", "здоровье", "одежда", "развлечения", "подписки",
 "образование", "детям", "подарки", "путешествия", "кредиты и рассрочка",
 "помощь семье", "переводы", "прочее", "зарплата", "доход прочее"]

ПРАВИЛА ОПИСАНИЯ (description):
- 1-4 слова, суть операции без суммы. "кофе в старбакс 1200" → "кофе".
